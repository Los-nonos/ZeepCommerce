...
module.exports = {
  description: 'Add an organism component',
  prompts: [
    {
      type: 'input',
      name: 'name',
  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/index.js',
      ...
      {
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/constants.js',
      ...
      {
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/tests/index.test.js',
      ...
      {
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/Loadable.js',
    ...
    if (data.wantMessages) {
      actions.push({
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/messages.js',
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/actions.js',
      ...
      actions.push({
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/selectors.js',
      ...
      actions.push({
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/reducer.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: '../../app/components/organisms/{{properCase name}}/saga.js',
