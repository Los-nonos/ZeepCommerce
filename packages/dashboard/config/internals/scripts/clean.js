...
shell.mv('app/pages/LanguageProvider/tests', 'internals/templates/pages/LanguageProvider');
...
shell.cp('internals/templates/combineReducers.js', 'app/combineReducers.js');
shell.cp('internals/templates/store.jstore/ Remove the templates folder
